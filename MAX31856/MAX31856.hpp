...
public:
  MAX31856(uint miso, uint sck, uint mosi, uint cs);
  //MAX31856(spi_inst_t* spi, uint miso, uint sck, uint mosi, uint cs);
  //void read_registers1(uint8_t reg, uint8_t *buf, uint16_t len);
  //void write_registers1(uint8_t reg, uint8_t *buf, uint16_t len);
  void read_registers(uint8_t reg, uint8_t *buf, uint16_t len);
  void write_registers(uint8_t reg, uint8_t *buf, uint16_t len);
